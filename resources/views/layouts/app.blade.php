      ...
      @if(auth()->user()->role_id == 1)
        ...
        <li class="nav-item">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="{{route('VerPisos')}}">Ver Pisos</a>
              <a class="collapse-item" href="{{route('VerHabitaciones')}}">Ver Habitaciones</a>            
              <a class="collapse-item" href="{{route('Pisos')}}">Crear Piso</a>
              <a class="collapse-item" href="{{route('Habitaciones')}}">Crear Habitacion</a>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">Qué quieres hacer:</h6>
              <a class="collapse-item" href="{{route('VerElementos')}}">Ver</a>
              <a class="collapse-item" href="{{route('Componentes')}}">Crear Elementos</a>
            </div>
          </div>
        </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            ...
            <span>CLINICA PERFECT BODY MEDICAL CENTER</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
